...
#
# Developer Command Center — production image (spec §36).
# Multi-stage: dependencies → build → minimal runtime with a non-root user.
...
# Build-time placeholders: real values are injected at runtime, never baked in.
